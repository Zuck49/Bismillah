...
───────────────────────────────────────────────────────
 ...
 [\x1b[1;96m+%s] RECODE   : Niki
 [\x1b[1;96m+%s] Instagram.com/goleradya
───────────────────────────────────────────────────────\n'''%(N,N,N,N))
...
class menu:
	...
	def main(self):
		...
		print(' %s╠═[%sU%s] Token free        [ON]'%(N,O,N))
		self.pilih()
	...
	def pilih(self):
		...
		if usna in ['']:
			...
			nom_wa ='+6281388498596'
			kata = input(' %s╚═[%s!%s] TOKEN FREE  : %s'%(N,O,N,H))
